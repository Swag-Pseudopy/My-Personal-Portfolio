...
import { Github, Linkedin, Mail, Download, Moon, Sun, ExternalLink, BookOpen, FileText, X, Sparkles, Wind } from "lucide-react";
...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen text-zinc-600 dark:text-zinc-400 selection:bg-zinc-200 dark:selection:bg-zinc-800 selection:text-zinc-900 dark:selection:text-zinc-200 transition-colors duration-300">
      ...
      {/* Main wrapper uses 'relative' to contain the Glassmorphism pane */}
      <div className="relative mx-auto min-h-screen max-w-screen-xl">
        
        {/* THE FROSTED GLASS PANE: Keeps text legible over glowing waves */}
        <div className="absolute inset-0 -z-10 bg-white/70 dark:bg-black/70 backdrop-blur-[12px] sm:border-x border-zinc-200/50 dark:border-zinc-800/50 transition-colors duration-300"></div>

        {/* Content padded inside the glass wrapper */}
                ...
                <div className="flex flex-col items-start w-full">
                  ...
                  <div className="flex w-full justify-between items-start mb-6">
                    ...
                    <div className="flex gap-3 z-50">
                      ...
                      {/* Simplified Theme Toggle (Dark/Light only) */}
                      {mounted && (
                        <motion.button
                          initial={{ opacity: 0 }}
                          animate={{ 
